...
<div class="container-fluid">
   ...
   <div class="topper-list">
    <h3 class="inner-sidebar-heading">Top Rankers</h3>
    <table class="table">
      <tbody>
