    ...
    <?php 
      if (isset($_POST['generate'])) {
        ...
        if ($name == "" || $occupation == "") {
		  ...
		  //function to display occupation name on certificate picture
          $text3 = imagettftext($createimage, 16, $rotation, $origin3_x, $origin3_y, $black, $drFont, "90");
		  
		  //function to display occupation name on certificate picture
          $text4 = imagettftext($createimage, 30, $rotation, $origin2_x, $origin2_y, $red, $drFont, "Good Work");

          imagepng($createimage,$output,3);

 ?>
        <!-- this displays the image below -->
        <img src="http://localhost/jbktest/certificate/<?php echo $output; ?>" id="certificate">
        <br> 
        <br>
